...
$w_text=str_split($text,30);// splits the text into length of 7 and saves in a array since we need wrap cell of two cell we took $w_text[0], $w_text[1] alone.
...
$this->SetX($x_axis);
//$this->Cell($c_width,$c_height,'','LTRB',0,'L',0); //OROGINAL
$this->Cell($c_width,$c_height,'',0,1,'L',0); //OROGINAL
}
else{
    $this->SetX($x_axis);
    //$this->Cell($c_width,$c_height,$text,'LTRB',0,'L',0);}//OROGINAL
	$this->Cell($c_width,$c_height,$text,0,1,'L',0);}//OROGINAL
    } 
}
?>
